...
import { UserAppToken, UserAppTokenModel } from "@/src/database/models/UserAppToken";
import { Denied, RequirementNotSatisfied, TooManyResources } from "@/src/errors";
...
export const UserAppTokenResolvers: GQLResolvers & {
  ...
  UserAppToken: {
    ...
    subscriber: makePrivate((parent, args: {}, context) => context.batched.User.get(UserPK.parse(parent.subscriber))),
