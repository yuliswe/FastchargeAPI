...
} from "@/src/functions/gateway";
import { findUserSubscription } from "@/src/functions/subscription";
...
export const GatewayResolvers: GQLResolvers & {
  ...
  Query: {
    ...
    async checkUserIsAllowedForGatewayRequest(
      parent: {},
      { user, app, _forceBalanceCheck = false, _forceAwait = false }: GQLQueryCheckUserIsAllowedForGatewayRequestArgs,
